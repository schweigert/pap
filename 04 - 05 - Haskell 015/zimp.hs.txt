...
-- C = Caracteres Diferentes, T = Numero de Caracteres totais
puth c t = do
              P.putWord32be (toEnum c)
              P.putWord32be (toEnum t)
              
puts [] = P.flush
puts ((Folha c i):xs) = do
                           P.putWord8 (I.c2w c)
                           P.putWord32be (toEnum i)
                           puts xs

runput txt tam arv = do
                     puth (tamanho arv) (tamanho txt)
                     puts